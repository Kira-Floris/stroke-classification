...
def filter(df):
	...
	age = st.sidebar.slider('Select age range', 0.0, df['age'].max(), (0.0,df['age'].max()), key='age')
	...
	avg_glucose_level = st.sidebar.slider('Select average glucose range', 0.0, df['avg_glucose_level'].max(), (0.0,df['avg_glucose_level'].max()), key='avg_glucose_level')
	bmi = st.sidebar.slider('Select bmi range', 0.0, df['bmi'].max(), (0.0,df['bmi'].max()), key='bmi')
